...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private HashMap<Class<? extends Event<?>>, Callback> eventsMap=new HashMap<>();
    private HashMap<Class<? extends Broadcast>, Callback> broadcastMap=new HashMap<>();
    /**
        ...
        while (!terminated) {
        	try {
				...
				if(msg instanceof Broadcast) {
					broadcastMap.get(msg.getClass()).call(msg);
				}
				else {
                    eventsMap.get(msg.getClass()).call(msg);
				}
